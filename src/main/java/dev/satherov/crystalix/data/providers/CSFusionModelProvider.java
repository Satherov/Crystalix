            ...
            this.addModel(ResourceLocation.fromNamespaceAndPath(Crystalix.MOD_ID, "block/" + holder.getId().getPath()),
                    ModelInstance.of(
                            ...
                            ConnectingModelData.builder()
                                    ...
                                    .connection(DefaultConnectionPredicates.isSameBlock().and(DefaultConnectionPredicates.matchState(holder.get(), Pair.of(CrystalixGlass.TRANSPARENT, true), Pair.of(CrystalixGlass.INVISIBLE, false))))
                                    .build()
                    )
            );
            ...
            this.addModel(ResourceLocation.fromNamespaceAndPath(Crystalix.MOD_ID, "block/" + holder.getId().getPath() + "_colored"),
                    ModelInstance.of(
                            ...
                            ConnectingModelData.builder()
                                    ...
                                    .connection(DefaultConnectionPredicates.isSameBlock().and(DefaultConnectionPredicates.matchState(holder.get(), Pair.of(CrystalixGlass.TRANSPARENT, false), Pair.of(CrystalixGlass.INVISIBLE, false))))
                                    .build()
                    )
            );
