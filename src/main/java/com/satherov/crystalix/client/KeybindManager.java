...
public class KeybindManager {
    ...
    public static final KeyMapping DIRECTION_MODIFIER = register(CrystalixLanguage.KEY_DIRECTION_MODIFIER, GLFW.GLFW_KEY_LEFT_SHIFT);
    ...
    public static final KeyMapping CYCLE_INVISIBLE = register(CrystalixLanguage.KEY_INVISIBLE, GLFW.GLFW_KEY_C);
