...
public class EN_USProvider extends CrystalixLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(CrystalixLanguage.CONFIG_MAX_EDIT_OPERATION, "Per Tick Modification Limit");
        add(CrystalixLanguage.CONFIG_MAX_EDIT_FORCE, "Modification Hard Limit");
        add(CrystalixLanguage.CONFIG_JADE_MODE, "Jade Mode");
        add(CrystalixLanguage.CONFIG_JADE_CRYSTALIX_BLOCK, "Crystalix Block");
        
        add(CrystalixLanguage.MESSAGE_SIZE, "You seem to have a larget selection of blocks. This may take a few seconds");
